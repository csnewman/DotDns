...
{
    /// <summary>
    ///     Grant authorization to issue wildcard certificates to the holder of the given Issuer Domain Name.
    /// </summary>
    public class IssueWildProperty : CaaProperty
    {
        public override string Tag => "issuewild";

        /// <summary>
        ///     The issuer that has authority to issue wildcard certificates.
        /// </summary>
        public string IssuerDomainName { get; set; }

        private readonly Dictionary<string, string> _parameters;

        public IssueWildProperty(byte flags, ref DnsReadBuffer buffer) : base(flags)
        {
        ...
        public IssueWildProperty(string issuerDomainName)
        {
